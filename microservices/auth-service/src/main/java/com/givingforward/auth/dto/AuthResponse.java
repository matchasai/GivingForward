package com.givingforward.auth.dto;
...
public class AuthResponse {
    ...
    public AuthResponse withRefresh(String token, java.time.Instant expiresAt) {
        this.refreshToken = token;
        this.refreshExpiresAt = expiresAt.toEpochMilli();
        return this;
    }
}